...
\end{enumerate}
Three \texttt{sorry} declarations are deliberately retained as documentation of
\emph{refuted} conjectures (private dead-route declarations in
\texttt{MatrixDetermination.lean}, each marked FALSE/REFUTED in its docstring; none on
any live path); the four formerly-retained public stubs were deleted with their
refutation documentation kept as prose.
