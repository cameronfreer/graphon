...
The formalization contains exactly two \texttt{sorry}s, both planned to be
proved (no custom axioms are introduced):
\begin{enumerate}
...
\end{enumerate}
All other results are fully proved.  These \texttt{sorry}s will be
replaced with proofs.
