...
\begin{enumerate}
  ...
  \item \textbf{Determination pending theorem}
    (\texttt{cutDistance\_zero\_of\_homDensity\_eq}):
    depends on both of the above.
    Used by: convergence equivalence.
\end{enumerate}
All other declarations contain no additional \texttt{sorry}s.
These three \texttt{sorry}s will be replaced with proofs.
