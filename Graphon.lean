...
* `Graphon.InfiniteSampler` — Explicit infinite sampler for a fixed graphon: i.i.d. vertex/edge sources via `Measure.infinitePi`; the measurable sampler (issue #51, in progress)
