...
| `Graphon/RelInfiniteLaw.lean` | Foundation | Generic AHK program R2b (#105): compactness-based infinite extension — diagonal padded laws, Prokhorov subsequence, marginal identification via continuity; `infiniteLaw` + `infiniteLaw_map_restrictFin` |
