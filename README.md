...
| `Graphon/RelationalTopology.lean` | Foundation | Generic AHK program R1b: Boolean-product topology/σ-algebra on `RelStructure` — compact/Polish/standard-Borel, measurable restrictions, cylinder π-system generating the σ-algebra, finite-restriction measure extensionality (issue #104) |
