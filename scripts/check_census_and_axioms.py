...
AUDITED_DECLS = {
    ...
    "RelSignature.CoherentBasis.measurePreserving_rankLatentRelabel",
    "RelSignature.CoherentBasis.RankCoding.coupling",
    "RelSignature.CoherentBasis.RankCoding.map_prodMap_relabel",
