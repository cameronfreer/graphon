...
AUDITED_DECLS = {
    ...
    "RelSignature.pollBlock_subset",
    "RelSignature.pollBlock_inter",
    "RelSignature.pollBlock_image_pollPerm_of_subset",
    ...
    "RelSignature.image_pollPerm_generator",
    "RelSignature.comap_relabel_fixingAlgebra_generator",
