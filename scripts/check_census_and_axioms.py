...
AUDITED_DECLS = {
    ...
    "RelSignature.InfiniteRelExchangeableLaw.pollingObs",
    "RelSignature.InfiniteRelExchangeableLaw.pooledBlock",
    "RelSignature.InfiniteRelExchangeableLaw.PooledPollingWitness.iCondIndepFun_blockMap",
